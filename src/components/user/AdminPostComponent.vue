    ...
    <div class="table-responsive">
      ...
      <table class="table table-bordered">
        ...
        <tr v-for="(post,key) in posts" :key="key">
          ...
          <td >
            <img v-for="(img,key) in post.files" :key="key" :src="'https://projectwithlaravelvuejs.herokuapp.com/public/images/' + img.name" alt="img" style="width: 50px; height: 50px;" class="m-1">
          </td>
